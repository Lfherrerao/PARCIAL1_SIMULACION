...
boxplot(argentina, main = 'ARGENTINA', col='red', ylab='POBLACION')
boxplot(EEUU,main = 'EE.UU',col='blue')
boxplot(Holanda ,main = 'HOLANDA',col='green')
boxplot(Japon,main = 'JAPON',col='pink')
